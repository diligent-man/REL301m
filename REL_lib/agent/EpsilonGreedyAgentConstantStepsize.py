...
__all__ = ["EpsilonGreedyAgentConstantStepsize"]
...
class EpsilonGreedyAgentConstantStepsize(Agent):
    def agent_step(self, reward: float, observation: np.ndarray) -> int:
        ...
        Useful Class Variables
            ...
            last_action : An int of the action that the agent took on the previous time step.
            step_size : A float which is the current step size for the agent.
        ...
        step_size = user-defined step size
        """
